...
import com.cortex.interfaces.CortexInterface;
import com.cortex.translators.ObjectTranslator;
import com.cortex.translators.Translator;
import com.cortex.util.ProcessTools;
import java.io.File;
...
public class Cortex {
    ...
    private void addAllTranslators() {
        Reflections reflections = new Reflections("com.cortex.translators");
